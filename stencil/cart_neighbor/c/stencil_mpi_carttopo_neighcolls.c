...
//  printf("%i (%i,%i) - w: %i, e: %i, n: %i, s: %i\n", r, ry,rx,west,east,north,south);
  ...
  for(int iter=0; iter<niters; ++iter) {
    ...
    /* ====================================================== *
     *                         Exercise                       *
     *  Utilize the Cartesian topology (topocomm) to perform  *
     *  variable-size message passing with neighbors using    *
     *  the non-blocking MPI_Ineighbor_alltoallv function.    *
     * ====================================================== */
    MPI_Request req;
    MPI_Status status;
    // TODO: Step 1 - build counts array

    // TODO: Step 2 - build displacements array

    // TODO: Step 3 - call MPI_Ineighbor_alltoallv

    // TODO: Step 4 - call MPI_Wait
    /* ====================================================== */
